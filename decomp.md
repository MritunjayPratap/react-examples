...
/********** you need to write a setCount function and then write the logic if increment inside it, you 
...
class App extends React.Component {
  /***********************************
.handleClick1 will print the 'MyComponent';handleClick2 will alert also alert  'MyComponent', 
handleClick3  will print undefined, seems like a lambda function, so it has its own this value
**************8/
  constructor() {
    super(); 
